...
Future publishConnect(RTCVideoRenderer localRenderer, String streamName, String pubTok) async {
  ...
  Publish publish = Publish(streamName: 'Buyrun Dostlar Buyrun', tokenGenerator: tokenGenerator);

  final Map<String, dynamic> constraints = <String, bool>{'audio': true, 'video': true};
